...
def get_course_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="1", callback_data="course_1"), InlineKeyboardButton(text="2", callback_data="course_2")],
        [InlineKeyboardButton(text="3", callback_data="course_3"), InlineKeyboardButton(text="4", callback_data="course_4")],
        [InlineKeyboardButton(text="5", callback_data="course_5"), InlineKeyboardButton(text="Магистр", callback_data="course_6")]
    ])
